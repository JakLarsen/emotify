...
class LiveAdvance():
    ...
    """
    def __init__(self): #added user parameter - MC
        """
        ...
        """
        self.c = Cortex(jake_user, debug_mode=True)
    ...
    def load_profile(self, profile_name):
        """
        To load an existed profile Parameters
        ----------
        profile_name : str, required profile name
        Returns
        -------
        None
        """
